    ...
    <div>
        ...
        <div className={personalPage}>
            ...
            <span style={{ color: 'rgba(255, 255, 255, 0.65)' }}>
              <img className={styles.personalimg} src={ShellImg} alt="Data and its Manipulation" /><br /><br />
              ...
              <img className={styles.personalimg} src={ShellImg} alt="Design and Implementation" /><br /><br />
              ...
              <video className={styles.personalvideo} alt="Music and the Visual Arts" autoPlay loop playsInline><source src={Music} type="video/mp4" /></video><br /><br />
              ...
              <video className={styles.personalvideo} alt="Personality and Drive" autoPlay loop playsInline><source src={Photocomp} type="video/mp4" /></video><br /><br />
