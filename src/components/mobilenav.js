          ...
          <li>
            <mobile>
              <Link onClick={handleLinkClick} to="/">
                Home <img className="ArrowImg" alt="Right Arrow" src={Arrow} />
              </Link>
            </mobile>
          </li>
          <li>
            <mobile>
              <Link onClick={handleLinkClick} to="/about">
                About <img className="ArrowImg" alt="Right Arrow" src={Arrow} />
              </Link>
            </mobile>
          </li>
          <li>
            <mobile>
              <Link onClick={handleLinkClick} to="/work">
                Work <img className="ArrowImg" alt="Right Arrow" src={Arrow} />
              </Link>
            </mobile>
          </li>
          <li>
            <mobile>
              <Link onClick={handleLinkClick} to="/personal">
                Personal{" "}
                <img className="ArrowImg" alt="Right Arrow" src={Arrow} />
              </Link>
            </mobile>
          </li>
          <br />
