    ...
    <div>
        ...
        <div className={personalPage}>
            ...
            <span style={{ color: 'rgba(255, 255, 255, 0.65)' }}>
              ...
              <video className={styles.personalvideo} alt="Music and the Visual Arts" autoPlay muted loop playsInline><source src={Music} type="video/mp4" /></video><br /><br />
              ...
              <video className={styles.personalvideo} alt="Personality and Drive" autoPlay muted loop playsInline><source src={Photocomp} type="video/mp4" /></video><br /><br />
