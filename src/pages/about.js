        ...
        <div className="grid-container5050">
          ...
          <div className="grid-item5050">
            <span className={styles.abouttext}>
              ...
              senior at Rhodes College studying Computer Science. I am currently
              interested in AI/ML, data structures/algorithms, and statistical
              methods—especially the effects applications of such topics can
              have on our society and day to day lives. I am advanced in Python;
              proficient in C, SQL, and Java; and experienced in C++, HTML/CSS,
              JavaScript, Node.js/React.js, and R.
              <br />
              <br />
